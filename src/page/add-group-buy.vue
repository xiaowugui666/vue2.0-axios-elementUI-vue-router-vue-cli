    ...
    <div class="add-activity-object">
      <div class="add-activity-content">
        ...
        <div class="activity-setting-list plate">
          <ul>
            <li>
              <span class="name required">活动起止时间：</span>
            ...
            <li>
              <span class="name required">拼团失效时间：</span>
               <input type="text" v-validate="{required:true,numeric:true,min_value: 1,max_value:99999999999}" maxlength="11" name="拼团失效时间" v-model="stock">
              <div class="err-tips" v-if="errors.has('拼团失效时间')" style="color: red;margin-top: 5px;margin-left: 80px;">{{errorserrors.first('拼团失效时间')}}</div>
            </li>
            <li>
              <span class="name required">开团人数：</span>
              <input type="text" v-validate="{required:true,numeric:true,min_value: 2,max_value:99999999999}" maxlength="11" name="开团人数" v-model="stock">
              <div class="err-tips" v-if="errors.has('开团人数')" style="color: red;margin-top: 5px;margin-left: 80px;">{{errors.first('开团人数')}}</div>
            </li>
            <li>
              <span class="name required">单个用户购买次数上限：</span>
              <input type="text" v-validate="{required:true,numeric:true,min_value: 3,max_value:99999999999}" maxlength="11" name="单个用户购买次数上限" v-model="stock">
              <div class="err-tips" v-if="errors.has('单个用户购买次数上限')" style="color: red;margin-top: 5px;margin-left: 80px;">{{errors.first('单个用户购买次数上限')}}</div>
            </li>
            <li>
              <el-button
                type="success"
